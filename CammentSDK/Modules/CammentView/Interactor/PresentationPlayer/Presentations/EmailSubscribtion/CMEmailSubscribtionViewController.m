...
#import "CMEmailSubscribtionViewController.h"
#import "CMStore.h"


@interface CMEmailSubscribtionViewController () <UIWebViewDelegate>
...
@implementation CMEmailSubscribtionViewController {
...
- (void)viewDidLoad {
    ...
    NSString* htmlPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"emailform" ofType:@"html"];
