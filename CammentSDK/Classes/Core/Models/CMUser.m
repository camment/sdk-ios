...
{
  return [NSString stringWithFormat:@"%@ - \n\t userId: %@; \n\t cognitoUserId: %@; \n\t fbUserId: %@; \n\t username: %@; \n\t firstname: %@; \n\t lastname: %@; \n\t email: %@; \n\t visibility: %@; \n\t userPhoto: %@; \n\t status: %zd; \n", [super description], _userId, _cognitoUserId, _fbUserId, _username, _firstname, _lastname, _email, _visibility, _userPhoto, _status];
}

- (NSUInteger)hash
{
  NSUInteger subhashes[] = {[_userId hash], [_cognitoUserId hash], [_fbUserId hash], [_username hash], [_firstname hash], [_lastname hash], [_email hash], [_visibility hash], [_userPhoto hash], ABS(_status)};
