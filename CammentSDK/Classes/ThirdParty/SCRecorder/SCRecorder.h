...
@interface SCRecorder : NSObject<AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureFileOutputRecordingDelegate, AVCaptureMetadataOutputObjectsDelegate>
...
@property (assign, nonatomic) UIInterfaceOrientationMask supportedInterfaceOrientation;
