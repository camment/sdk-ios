...
{
  return [NSString stringWithFormat:@"%@ - \n\t showUuid: %@; \n\t userGroupUuid: %@; \n\t uuid: %@; \n\t remoteURL: %@; \n\t localURL: %@; \n\t thumbnailURL: %@; \n\t userCognitoIdentityId: %@; \n\t localAsset: %@; \n\t isMadeByBot: %@; \n\t botUuid: %@; \n\t botAction: %@; \n\t isDeleted: %@; \n\t shouldBeDeleted: %@; \n", [super description], _showUuid, _userGroupUuid, _uuid, _remoteURL, _localURL, _thumbnailURL, _userCognitoIdentityId, _localAsset, _isMadeByBot ? @"YES" : @"NO", _botUuid, _botAction, _isDeleted ? @"YES" : @"NO", _shouldBeDeleted ? @"YES" : @"NO"];
}

- (NSUInteger)hash
{
  NSUInteger subhashes[] = {[_showUuid hash], [_userGroupUuid hash], [_uuid hash], [_remoteURL hash], [_localURL hash], [_thumbnailURL hash], [_userCognitoIdentityId hash], [_localAsset hash], (NSUInteger)_isMadeByBot, [_botUuid hash], [_botAction hash], (NSUInteger)_isDeleted, (NSUInteger)_shouldBeDeleted};
